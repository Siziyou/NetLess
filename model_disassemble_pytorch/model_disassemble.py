...
class Predictor():
    def __init__(self,src_model,transformer,Primary_Data_DIR) -> None:
        ...
        self.PrimaryData=self.test_load(Primary_Data_DIR)
    ...
    def testonnx_func(self, config_dir, model_dir,data_dir):
        ...
        #Input
            self.PrimaryData=self.test_load(data_dir+str(i)+".jpg")
...
if __name__ == "__main__":
    ...
    new_instance = Predictor(src_model=src_model,transformer=weights,Primary_Data_DIR=PICTURE_DIR+str(1)+".jpg")
